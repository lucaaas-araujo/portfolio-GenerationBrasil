...
async function getAboutGithub(){
    try {
        const resposta = await fetch('https://api.github.com/users/lucaaas-araujo');
        ...
        about.innerHTML += `
            ...
            <div class="about-buttons-data">
                <div class="buttons-container">
                    ...
                    <a href="https://docs.google.com/document/d/1zc_3Wap09bUeC1dFsKHU5Tp64sqY7Og67pDymf8WsCI/edit?tab=t.0" target="_blank" class="botao-outline">Currículo</a>
                </div>
...
async function getProjectsGithub() {
  try {
    ...
    const resposta = await fetch(
      'https://api.github.com/users/lucaaas-araujo/repos?sort=updated&per_page=6'
    );
