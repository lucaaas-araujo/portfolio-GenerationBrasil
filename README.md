...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/lucaaas-araujo/portfolio-GenerationBrasil.git
   ```

2. Acesse a pasta do projeto:

   ```bash
   cd portfolio-GenerationBrasil
   ```
...
🔗 https://lucaaas-araujo.github.io/portfolio-GenerationBrasil
